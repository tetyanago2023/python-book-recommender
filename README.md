...
This repo contains all of the code in order to build a Semantic Book Recommender with LLMs. There are five components to this tutorial:
...
In order to create your vector database, you'll need to create a .env file in your root directory containing your Huggingfaces API key. You can get this by signing up for a free account on Huggingface's website.
